...
enum UIAttributeType : uint16 {
    ...
    UI_ATTRIBUTE_TYPE_INHERIT,
    UI_ATTRIBUTE_TYPE_CLASS,

    UI_ATTRIBUTE_TYPE_UPDATE,
    ...
    UI_ATTRIBUTE_TYPE_CONTENT_LENGTH,
    UI_ATTRIBUTE_TYPE_CONTENT_ALIGN_H,
    UI_ATTRIBUTE_TYPE_CONTENT_ALIGN_V,

    UI_ATTRIBUTE_TYPE_PATTERN,
    UI_ATTRIBUTE_TYPE_PATTERN_LENGTH,
    ...
    UI_ATTRIBUTE_TYPE_ANCHOR,
    UI_ATTRIBUTE_TYPE_ALIGNMENT,
