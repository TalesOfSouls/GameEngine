...
//     PngHuffman* literal_length_huffman = (PngHuffman *) memory_get(ring, sizeof(PngHuffman));
//     literal_length_huffman->max_code_length = 15;
//     literal_length_huffman->count = 1 << literal_length_huffman->max_code_length;

//     PngHuffman* distance_huffman = (PngHuffman *) memory_get(ring, sizeof(PngHuffman));
//     distance_huffman->max_code_length = 15;
//     distance_huffman->count = 1 << distance_huffman->max_code_length;

//     PngHuffman* dictionary_huffman = (PngHuffman *) memory_get(ring, sizeof(PngHuffman));
...
//     uint8* finalized = memory_get(ring, src.ihdr.width * src.ihdr.height * bytes_per_pixel);

//     // Needs some extra space
//     uint8* decompressed = memory_get(ring, src.ihdr.width * src.ihdr.height * bytes_per_pixel + src.ihdr.height);
...
//             palette = memory_get(ring, chunk.length);
...
//             // @todo remove, we can store this information directly in the palette
//             transparency.values = memory_get(ring, chunk.length);
