...
#include "../../../stdlib/Stdlib.h"
    ...
    #define SETUPAPI_SetupDiEnumDeviceInterfaces SetupDiEnumDeviceInterfaces
    #define SETUPAPI_SetupDiGetDeviceInterfaceDetailW SetupDiGetDeviceInterfaceDetailW
    #define SETUPAPI_SetupDiDestroyDeviceInfoList SetupDiDestroyDeviceInfoList
#else
    ...
    #define SETUPAPI_SetupDiGetClassDevsW pSetupDiGetClassDevsW
    #define SETUPAPI_SetupDiEnumDeviceInterfaces pSetupDiEnumDeviceInterfaces
    #define SETUPAPI_SetupDiGetDeviceInterfaceDetailW pSetupDiGetDeviceInterfaceDetailW
    #define SETUPAPI_SetupDiDestroyDeviceInfoList pSetupDiDestroyDeviceInfoList
