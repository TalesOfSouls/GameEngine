...
void template_find(const char* path, va_list args) {
    ...
    if (path_count == max_path_count) {
        ...
        *max_path_count += 1000;
        char* new_paths = (char *) memory_get(ring, (*max_path_count) * 256 * sizeof(char), sizeof(size_t));
...
void template_cache_alloc(
    ...
    uint32 path_count = 0;
    char* paths = (char *) memory_get(ring, max_path_count * 256 * sizeof(char), sizeof(size_t));
